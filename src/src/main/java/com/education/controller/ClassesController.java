...
public class ClassesController {
	...
	@Operation(summary="to add the class")
	...
	@Operation(summary="it display all the class list")
	public ResponseEntity<?> getAllClass()
	{
		
		List<ClassDTO> ct=classService.getAllClasses();
		return  new ResponseWithList().generateResponse("provide",HttpStatus.OK,"200",ct);
	}
}
